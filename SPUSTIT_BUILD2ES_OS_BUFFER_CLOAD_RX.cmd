...
echo.
echo ===============================================
echo  AtariHelp.eu EMU-10 BUILD2ES CLOAD RX oprava
echo ===============================================
echo.
...
if not exist "_EMU10_BUILD2ES_PAYLOAD\app\src\main\assets\emu\index.html" (
  echo CHYBA: Chybi payload _EMU10_BUILD2ES_PAYLOAD.
  echo Zkopiruj do korene projektu CMD i slozku _EMU10_BUILD2ES_PAYLOAD.
  pause
  exit /b 1
)
echo Zalohuji puvodni index.html...
copy /Y "app\src\main\assets\emu\index.html" "app\src\main\assets\emu\index_BACKUP_BEFORE_BUILD2ES.html" >nul
if errorlevel 1 (
...
copy /Y "_EMU10_BUILD2ES_PAYLOAD\app\src\main\assets\emu\index.html" "app\src\main\assets\emu\index.html" >nul
if errorlevel 1 (
...
echo.
echo HOTOVO: BUILD2ES nainstalovan.
