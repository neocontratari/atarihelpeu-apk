...
const html=fs.readFileSync('/mnt/data/fix50/app/src/main/assets/emu09_pmg_gtia_overlay.html','utf8');
...
vm.runInContext(js,ctx,{filename:'emu09_fix50.js'});
...
ctx.compatibilitySnapshot(); if(!String(elements.log.textContent||'').includes('FIX50_GENERIC_XEX_CORE')) throw new Error('missing FIX50 log tag');
