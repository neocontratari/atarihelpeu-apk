...
LOG MARKERY:
- BUILD2RK_SEGA_NATIVE_CPP_ONLY_WORKFLOW_FIX_STAGE127
- NATIVE_AUDIO_STREAM_START_RK_AUDIO_MASTER_FRONTEND_QT
- NATIVE_AUDIO_PULL_RK_AUDIO_MASTER_FRONTEND_QT
- FM_PSG_MASTER_FRONTEND_RK
- fixedAudioClock=YES
- fmGain=16 psgGain=12 masterGain=85
- desyncDrops=0
- NATIVE_PERF_MODE_OK_RK mode=LOW/HIGH target=4096 max=16384 lowWater=1536
- REAL_CORE_RENDER_OK_WORKER_THREAD_RK
