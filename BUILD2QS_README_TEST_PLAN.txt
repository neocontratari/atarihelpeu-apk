...
LOG MARKERY:
- BUILD2QT_SEGA_NATIVE_CPP_ONLY_BUTTON_FIX_QP_AUDIO_STAGE110
- NATIVE_AUDIO_STREAM_START_QT_QP_CLEAN
- audio_mode=FM_PSG_QP_CLEAN_VIDEO_WATCHDOG_QT
- NATIVE_EU_COMPAT_FOR_CPP
- frameReady=YES
- frameCounter=
- NATIVE_RENDER_WATCHDOG_QT
- NATIVE_RENDER_WATCHDOG_RELOAD_QT
- NATIVE_RENDER_NO_FRAME_AUDIO_STOPPED_QT
- NATIVE_SHUTDOWN_OK_QT_CPP_ONLY
