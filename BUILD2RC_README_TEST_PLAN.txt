BUILD2RC_SEGA_NATIVE_CPP_ONLY_MULTIROM_AUDIO_VIDEO_FIX_STAGE119
...
BUILD2RC HOTFIX PO WORKFLOW KRIZKU:
- Pred testem over, ze GitHub Actions projde buildem.
- Zmena je minimalni compile hotfix, ne nova gameplay zmena.
