...
{
    // Kopie obrazu pro texturovani. Musi vzniknout PO dokresleni snimku,
    ...
    // (Texturu nahrava n2_flush() tesne pred kreslenim davky - tam uz jsou
    //  zapisy jadra hotove. Nahravat ji tady bylo o snimek pozde.)
    n2_flush();
    // ===== ROZHODUJICI MERENI =====
