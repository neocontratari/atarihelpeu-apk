...
/**
 * BUILD2QD_SEGA_NATIVE_CPP_CORE_SLOT_READY_STAGE87
 *
...
public class NativeSegaProofActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appendLog("BUILD2QD NativeSegaProofActivity onCreate");
        ...
        title.setText("SEGA C++ TEST / BUILD2QD");
        right.addView(title);
    ...
    private String buildCppLogText() {
        StringBuilder sb = new StringBuilder();
        sb.append("SEGA C++ TEST LOG / BUILD2QD\n");
        sb.append("AtariHelp.eu EMU-10 BUILD2QD_SEGA_NATIVE_CPP_CORE_SLOT_READY_STAGE87\n\n");
    ...
    private void saveCppLog() {
        try {
            ...
            String file = "AtariHelp_SEGA_CPP_LOG_BUILD2QD_" + stamp + ".txt";
