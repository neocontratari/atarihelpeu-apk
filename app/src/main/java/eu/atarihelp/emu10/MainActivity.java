...
public class MainActivity extends Activity {
    ...
    private String buildNativeInPlaceLog() {
        ...
        out.append("SEGA C++ IN-PLACE LOG / BUILD2PZ\n");
        out.append("AtariHelp.eu EMU-10 BUILD2PZ_SEGA_NATIVE_CPP_CORE_SLOT_READY_STAGE87\n\n");
    ...
    public class AHNative {
        ...
        public String saveLog() {
            try {
                String fn = "AtariHelp_SEGA_CPP_INPLACE_LOG_BUILD2PZ_" + new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.US).format(new Date()) + ".txt";
