...
/**
 * BUILD2RT: Java -> JNI bridge for C++ core directly inside the normal Sega screen.
...
public final class NativeSegaCoreBridge {
    ...
    // BUILD2RT: real-core adapter slot + C++ only audio-master no-starve lifecycle.
    ...
    public static native String setAudioMode(String mode);
    public static native String configureRuntime(int sdk, int cores, String model);

    // BUILD2RT: tvrdy lifecycle stop pro normalni app stranky.
