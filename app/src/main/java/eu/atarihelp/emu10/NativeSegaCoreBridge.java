...
/**
 * BUILD2QY: Java -> JNI bridge for C++ core directly inside the normal Sega screen.
...
public final class NativeSegaCoreBridge {
    ...
    // BUILD2QY: real-core adapter slot + C++ only QT-audio-kept + blackscreen guard lifecycle.
    ...
    // BUILD2QY: tvrdy lifecycle stop pro normalni app stranky.
