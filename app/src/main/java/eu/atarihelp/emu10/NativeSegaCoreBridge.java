...
/**
 * BUILD2QF: Java -> JNI bridge for C++ core directly inside the normal Sega screen.
...
public final class NativeSegaCoreBridge {
    ...
    // BUILD2QF: real-core adapter slot. It compiles now and reports whether a vendor core is present.
