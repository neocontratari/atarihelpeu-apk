...
/**
 * BUILD2QZ: Java -> JNI bridge for C++ core directly inside the normal Sega screen.
...
public final class NativeSegaCoreBridge {
    ...
    // BUILD2QZ: real-core adapter slot + C++ only QT-audio-kept + blackscreen guard lifecycle.
    ...
    // BUILD2QZ: tvrdy lifecycle stop pro normalni app stranky.
