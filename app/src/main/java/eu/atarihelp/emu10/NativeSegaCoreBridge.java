...
/**
 * BUILD2QT: Java -> JNI bridge for C++ core directly inside the normal Sega screen.
...
public final class NativeSegaCoreBridge {
    ...
    // BUILD2QT: real-core adapter slot + C++ only QP-clean audio + render watchdog lifecycle.
    ...
    // BUILD2QT: tvrdy lifecycle stop pro normalni app stranky.
