...
/**
 * BUILD2PZ: Java -> JNI bridge for C++ core directly inside the normal Sega screen.
...
public final class NativeSegaCoreBridge {
    ...
    // BUILD2PZ: real-core adapter slot. It compiles now and reports whether a vendor core is present.
