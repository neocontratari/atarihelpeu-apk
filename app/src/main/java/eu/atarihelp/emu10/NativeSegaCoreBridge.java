...
/**
 * BUILD2QU: Java -> JNI bridge for C++ core directly inside the normal Sega screen.
...
public final class NativeSegaCoreBridge {
    ...
    // BUILD2QU: real-core adapter slot + C++ only QP-clean audio + render watchdog lifecycle.
    ...
    public static native String clearAudioQueue();

    // BUILD2QU: tvrdy lifecycle stop pro normalni app stranky.
