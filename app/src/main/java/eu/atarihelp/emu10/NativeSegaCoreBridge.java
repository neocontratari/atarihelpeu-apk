...
/**
 * BUILD2RQ: Java -> JNI bridge for C++ core directly inside the normal Sega screen.
...
public final class NativeSegaCoreBridge {
    ...
    // BUILD2RQ: real-core adapter slot + C++ only balanced audio-clock lifecycle.
    ...
    // BUILD2RQ: tvrdy lifecycle stop pro normalni app stranky.
