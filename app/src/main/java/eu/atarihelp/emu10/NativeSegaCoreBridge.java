...
/**
 * BUILD2RR: Java -> JNI bridge for C++ core directly inside the normal Sega screen.
...
public final class NativeSegaCoreBridge {
    ...
    // BUILD2RR: real-core adapter slot + C++ only audio-master no-starve lifecycle.
    ...
    // BUILD2RR: tvrdy lifecycle stop pro normalni app stranky.
