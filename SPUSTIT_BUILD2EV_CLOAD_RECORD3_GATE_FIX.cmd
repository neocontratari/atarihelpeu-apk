...
setlocal
echo ============================================================
echo AtariHelp.eu EMU-10 BUILD2EV CLOAD RECORD3 GATE FIX
echo ============================================================
echo.
...
if not exist "_EMU10_BUILD2EV_PAYLOAD\app\src\main\assets\emu\index.html" (
  echo CHYBA: Chybi _EMU10_BUILD2EV_PAYLOAD. Zkopiruj CMD i payload do korene projektu.
  pause
  exit /b 1
)

set BACKUPDIR=_backup_index_BUILD2EV_%DATE:/=-%_%TIME::=-%
set BACKUPDIR=%BACKUPDIR: =_%
mkdir "%BACKUPDIR%" >nul 2>nul
copy /Y "app\src\main\assets\emu\index.html" "%BACKUPDIR%\index.html" >nul

copy /Y "_EMU10_BUILD2EV_PAYLOAD\app\src\main\assets\emu\index.html" "app\src\main\assets\emu\index.html" >nul
if errorlevel 1 (
...
echo.
echo HOTOVO: BUILD2EV nainstalovan.
